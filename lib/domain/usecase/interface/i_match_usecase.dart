...
abstract class MatchUseCaseInterface {
  Future<Either<Failures, List<match.Match>>> getTeamMatches(String teamId);

  Future<Either<Failures, void>> swipe(String hostTeamId, String opposingTeamId,
      bool hasInvite);
  ...
  Future<Either<Failures, void>> selectStadium(String matchId, String stadiumId,
      String teamId);
