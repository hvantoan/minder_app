...
class SwipeTeamPage extends StatefulWidget {
  ...
  @override
  State<SwipeTeamPage> createState() => _SwipeTeamPageState();
}

class _SwipeTeamPageState extends State<SwipeTeamPage> {
  double angle = 0;
  ...
  void initState() {
    setState(() {
      ...
      cards.addAll(teams.map((team) => TeamWidget.card(team: team)));
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return cards.isNotEmpty
        ...
        : Center(
            child: Text(
                widget.isInvite
                    ? S.current.txt_no_invitation
                    : S.current.txt_no_recommend,
